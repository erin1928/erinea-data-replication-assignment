...
Flower_species
means
barplot(means, ylim = c(0.00, 0.20), names.arg = Flower_species, space = 0.05, xlab = "Flower Species", ylab = "Pollen Proportion", main = "Pollen Proportion vs. Flower Species")
