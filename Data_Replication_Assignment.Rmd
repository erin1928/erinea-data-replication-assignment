...
coul <- brewer.pal(14, "Set2")
barplot(means, ylim = c(0.00, 0.20), names.arg = Flower_species, las = 2, space = 0.05, xlab = " ", ylab = " ", main = "Pollen Proportion vs. Flower Species", col=coul)
#I want to add names.arg = Flower_species after c(0.00, 0.20) but R is telling me it's an incorrect number of names even though I have counted 14 means and 14 species names
